...
function Signup() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Assuming you want to provide visual feedback as before
      setErrors({
        ...errors,
        fetchError: true,
      ...
      // Handle errors returned by the server or axios itself
      if (error.response && error.response.data) {
        ...
        // An error occurred before making a request or there was a network issue
        setErrors({
          ...errors,
          fetchError: true,
